...
public interface DemandModel extends Initialisable, Displayable {
	...
	/**
	 * @return demand map per cell averaged over region or world (if {@link WorldDemandModel}.
	 */
	...
	/**
	 * @return residual demand map per cell averaged over region or world (if {@link WorldDemandModel}.
	 */
